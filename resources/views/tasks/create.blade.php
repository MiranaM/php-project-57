                    ...
                    <form action="{{ route('tasks.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description"
                                      ...
                                      rows="4"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm
                                             focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        {{-- Status --}}
                        <div class="mb-4">
                            <label for="status_id" class="block text-sm font-medium text-gray-700">{{ __('Статус') }}</label>
                        ...
                        {{-- Assignee --}}
                        <div class="mb-4">
                            <label for="assigned_to_id" class="block text-sm font-medium text-gray-700">{{ __('Исполнитель') }}</label>
